...
//! пока в массиве меньше элементов, чем нужно — крутимся

//! while (true)
//!     true всегда истинно → цикл никогда сам не остановится
//! чтобы выйти, нужно использовать break или return

//! throw new Error('что-то пошло не так');
//! останови выполнение и скажи, что что-то пошло не так


//! сделать date отдельно в ексель
