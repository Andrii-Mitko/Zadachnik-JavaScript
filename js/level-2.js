...
// const str = '12b34k56g';
// let quantity = 0;
// str.split('').forEach((n) => /[a-zA-Z]/.test(n) ? quantity += 1 : null)
...
// const num = 123456;
// const res = String(num).split('').reverse().find(n => Number(n) % 2 === 0);
// console.log(res);
...
// const res = str.split(' ').map(n => ('!' + n.slice(1)));
// console.log(res.join(' '));
...
// console.log(arr.some((n, i, a) => n === a[i + 1])); 
