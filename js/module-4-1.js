...
//     far(gr, tC) {
//         let faren = 0;
//         tC === 'Celsius' ? faren = (gr * (9 / 5)) + 32 : null;
//         console.log(`°C → °F Температура при ${gr} по  = ${faren}`);   
//     },
//     cel(gr, tC) {
//         let cels = 0;
//          tC === 'Fahrenheit' ? cels = (gr - 32) * (5 / 9) : null;
//         console.log(`°F → °C Температура при ${gr} = ${cels}`); 
//     },
// };
// temperatureConverter.far(36.6, 'Celsius');
// temperatureConverter.cel(87, 'Fahrenheit');
